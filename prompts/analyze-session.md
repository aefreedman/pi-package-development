...
3. Inspect typed failure source/confidence, correlated incidents, latency/concurrency, retry recovery, corrective mutations, and public tool-call amplification before interpreting raw counts.
